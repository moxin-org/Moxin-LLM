...
def main():
    ...
    parser.add_argument("--cache_path", type=str, default="workspace/.cache/huggingface/datasets", help="cache path")
    ...
    parser.add_argument("--accumulation_steps", default=8, help="accumulation steps")
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.expanded_model, use_fast=False)
    tokenizer.pad_token = tokenizer.unk_token
    tokenizer.padding_side  = 'left'
    # ================================================================

    dataset = load_dataset(args.dataset, cache_dir=args.cache_path)
    ...
    with init_ctx:
        ...
        model = LlamaForCausalLM.from_pretrained(args.expanded_model, torch_dtype=torch.float16)
